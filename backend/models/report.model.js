...
const reportSchema = new mongoose.Schema({
    ...
    type: { type: String, enum: ['suspicious', 'credit-out', 'payouts', 'deposit_percentages', 'bulk_deposit_percentages', 'new-positions', 'account_transfer', 'bulk_transfer_accounts', 'profit_watching', '3days_balance', 'profit_leverage', 'same_price_sl', 'deals_no_profit', 'evaluation', 'other'], required: true },
